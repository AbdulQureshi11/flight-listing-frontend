...
const FlightSearch = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      const res = await axios.post("http://localhost:9000/api/search", payload);
      ...
      // 1. Save new data
      sessionStorage.setItem("flightResults", JSON.stringify(res.data.flights));
